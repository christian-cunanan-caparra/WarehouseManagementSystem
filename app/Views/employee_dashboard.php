                    ...
                    <?php foreach ($products as $product): ?>
                        <?php if ($product['status'] == 1): ?>
                            <tr>
                                ...
                                <td>
                                    <!-- Edit Button with data-id -->
                                    <a href="#" class="btn btn-warning btn-sm edit-product-btn" data-id="<?= $product['id'] ?>" data-bs-toggle="modal" data-bs-target="#editProductModal">Edit</a>
        ...
        <div class="modal fade" id="editProductModal" tabindex="-1" aria-labelledby="editProductModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- Product Edit Form -->
                        <form id="editProductForm" method="POST" action="/employee_dashboard/update">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.edit-product-btn').click(function () {
                ...
                $.ajax({
                    url: '/employee_dashboard/edit/' + productId, // Get product details by ID
                    type: 'GET',
            ...
            // Add New Product Form Submission (AJAX)
            $('#addProductForm').on('submit', function (e) {
                e.preventDefault(); // Prevent form from submitting normally
                var formData = $(this).serialize();

                $.ajax({
                    url: '/employee_dashboard/store',
                    type: 'POST',
                    data: formData,
                    success: function (response) {
            ...
            // Edit Product Form Submission (AJAX)
            $('#editProductForm').on('submit', function (e) {
                e.preventDefault(); // Prevent form from submitting normally
                var formData = $(this).serialize();

                $.ajax({
                    url: $(this).attr('action'), // Use action URL
                    type: 'POST',
                    data: formData,
                    success: function (response) {
                        if (response.status === 'success') {
                            ...
                            location.reload(); // Reload to see updated product
                        } else {
                            alert('Error: ' + response.message);
                        }
                    }
