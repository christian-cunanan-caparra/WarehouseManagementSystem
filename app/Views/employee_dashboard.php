...
<body>
                    ...
                    <?php foreach ($products as $product): ?>
                        <?php if ($product['status'] == 1): ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-warning btn-sm edit-btn" data-id="<?= $product['id'] ?>" data-name="<?= $product['name'] ?>" data-description="<?= $product['description'] ?>" data-quantity="<?= $product['quantity'] ?>" data-price="<?= $product['price'] ?>">Edit</button>
    ...
    <script>
        ...
        // Handle opening the edit modal with pre-filled values
