                    ...
                    <tbody>
                        <?php foreach ($products as $product): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                    <form action="/inventory/requestAddStock/<?= $product['id'] ?>" method="post" class="d-inline">
    <input type="number" name="quantity" min="1" required class="form-control form-control-sm">
    <button type="submit" class="btn btn-success btn-sm">Request Add Stock</button>
</form>

<form action="/inventory/requestRemoveStock/<?= $product['id'] ?>" method="post" class="d-inline">
    <input type="number" name="quantity" min="1" required class="form-control form-control-sm">
    <button type="submit" class="btn btn-danger btn-sm">Request Remove Stock</button>
</form>
